...
namespace NCas.Client.Utils
{
    public class AppSettingsUtils
    {
        ...
        private static string[] GetStringArray(string key, string separator, bool valueRequired = false,
            string[] defaultValue = default(string[]))
        {
            ...
            else
            {
                ...
                throw new ApplicationException(string.Format("在配置文件的appSettings节点集合中找不到key为{0}的子节点，且没有指定默认值", key));
            }
        }
        ...
        private static string GetValue(string key, bool valueRequired, string defaultValue = "")
        {
            ...
            throw new ApplicationException(string.Format("在配置文件的appSettings节点集合中找不到key为{0}的子节点", key));
        }
